...
export class FuncionalidadesComponent {
  ...
  contentData = [
    ...
    },
    {
      ...
      icon: 'fas fa-users',
      description:
        'Gestiona toda la información relacionada con las personas o empresas a las que vendes tus productos o servicios.',
    },
    {
      id: 'publicidad',
      title: '4. Publicidad',
      ...
      description:
        'Registra y organiza la información sobre tus campañas y esfuerzos publicitarios.',
    },
    {
      id: 'observaciones',
      ...
      description:
        'Un espacio flexible para registrar notas, comentarios o recordatorios importantes.',
    },
    {
      id: 'productos',
      ...
      icon: 'fas fa-box',
      description:
        'Administra el catálogo detallado de lo que ofreces a tus clientes.',
    },
    {
      id: 'formatos',
      title: '7. Formatos',
      ...
      description:
        'Gestiona las plantillas o diseños predefinidos para tus documentos.',
    },
  ];
